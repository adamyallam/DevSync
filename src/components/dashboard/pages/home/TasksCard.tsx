    ...
    return (
      <div className="w-550 h-96 border-2 border-gray-200 rounded-lg shadow-sm">
        ...
        <div className="flex items-center mt-8 ml-12">
          <div className="w-14 h-14 mb-5 border-2 border-undertone bg-gray-200 rounded-full"></div> {/* Profile Photo Placeholder */}
          ...
          <div className="flex flex-col gap-3 ml-5">
            ...
            <div className="flex gap-4">
              <div className="flex-col">
                ...
                <div className="border-2 mt-3 border-undertone"></div>
              </div>
