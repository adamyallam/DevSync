  ...
  return (
    <div>
      <div className='flex flex-col'>
        ...
        <h1 className='text-center mt-2 text-3xl text-[#212526]'>Good {getDayPeriod()}, {session?.firstName}</h1>
      </div>
      <div className='flex justify-center'>
        <div className='p-4 mt-4 w-[500px] bg-[#212526] rounded-full text-gray-100'>
          <div className='grid grid-rows-1 grid-cols-3 justify-center divide-x divide-[#D0E8E8]'>
