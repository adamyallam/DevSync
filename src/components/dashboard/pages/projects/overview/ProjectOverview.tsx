    ...
    <div className="relative flex flex-col ml-20 mt-8 h-full gap-2">
      ...
      <div className="flex flex-col w-full relative">
        <textarea
          ...
          className={`resize-none w-4/5 h-auto max-h-[225px] ml-0.5 ${!isExpanded ? "max-h-[225px]" : "max-h-none"} overflow-hidden outline-none bg-secondary placeholder-secondary-text text-primary-text hover:outline hover:outline-2 hover:outline-undertone focus:outline-2 focus:outline-secondary-text rounded-sm p-1`}
          placeholder="Type your description, welcome message, or project info here!"
          style={{ minHeight: "150px" }}
        />
          {!isExpanded && showSeeLess &&
            <div className="absolute bottom-4 w-[80.5%] h-[51px] pointer-events-none bg-gradient-to-t from-secondary via-secondary/75 via-100% to-transparent" />
          }
        {showSeeLess &&
